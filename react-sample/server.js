...
app.post('/confirm', async (req, res) => {
    ...
    */
    ...
    const paymentUrl = 'https://payments.korpay.com/payments/confirm';
    ...
    if (isApiSuccess) {
         ...
         */
        return res.redirect(`http://localhost:5173/success?orderNumber=${orderNumber}`);
    } else {
        return res.redirect(`http://localhost:5173/fail?orderNumber=${orderNumber}`);
    }
