...
$cancelApiUrl = "https://pgapi.korpay.com/cancelTransJson.do";
?>
    ...
    <div class="card-body">
        <form id="cancelForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="tid" name="tid" class="form-input" value="<?php echo $tid ?>" placeholder="TID 입력" required>
            </div>

            <div class="form-group">
                <label for="mid" class="form-label">MID (상점ID)</label>
                <input type="text" id="mid" name="mid" class="form-input" value="<?php echo $mid ?>" maxlength="10">
            </div>

            <div class="form-group">
                <label for="canAmt" class="form-label">취소 금액</label>
                <input type="number" id="canAmt" name="canAmt" class="form-input" value="<?php echo $canAmt ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="canId" name="canId" class="form-input" value="<?php echo $canId ?>" maxlength="20">
            </div>

            <div class="form-group">
                <label for="canNm" class="form-label">취소자 이름</label>
                <input type="text" id="canNm" name="canNm" class="form-input" value="<?php echo $canNm ?>">
            </div>

            <div class="form-group">
                <label for="canMsg" class="form-label">취소 사유</label>
                <input type="text" id="canMsg" name="canMsg" class="form-input" value="<?php echo $canMsg ?>" maxlength="100">
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const API_URL = "<?php echo $cancelApiUrl ?>";
        const partCanFlg = "<?php echo $partCanFlg ?>"; // 부분 취소 여부 [ 0 : 전체 , 1 : 부분 ]
        const payMethod = "<?php echo $payMethod ?>"; // 결제수단
